                ...
                <Grid stackable columns={2}>
                    <Grid.Column width={9}>
                        <div className="my-5">
                            ...
                            >
                                <br />
                                Never miss any new service ever again! <br /> <br />
                                Purrfect-Paws is now offering a monthly subscription that allows for exclusive access to
                                all of our upcoming services and items for your family friend. You'll always be the
                                first to know and will never have to feel the frustration of seeing 'sold out' again.
                            </p>
                        </div>
                    </Grid.Column>
                    <Grid.Column width={6}>
